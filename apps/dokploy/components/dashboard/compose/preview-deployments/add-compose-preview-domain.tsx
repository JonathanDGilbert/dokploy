...
export const AddComposePreviewDomain = ({
	...
	const { data: previewDeployment } =
		api.composePreviewDeployment.one.useQuery(
			{
				composePreviewDeploymentId,
			},
			{
				enabled: !!composePreviewDeploymentId,
			},
		);
	...
	const onSubmit = async (data: Domain) => {
		await mutateAsync({
			...
			.then(async () => {
				...
				await utils.composePreviewDeployment.all.invalidate({
